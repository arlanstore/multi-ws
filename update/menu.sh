...
Exp=$(curl -sS https://raw.githubusercontent.com/arlanstore/izinvps/ipuk/ip | grep $MYIP | awk '{print $3}')
fi
...
echo -e "□ AutoScript By arlanstore   = XDRG ${GREEN}( arlanstore )${NC}"
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
...
06 | 6) clear ; menu-dns ;;
07 | 7) clear ; gotop ;;
08 | 8) clear ; wget https://raw.githubusercontent.com/arlanstore/multi-ws/ipuk/update/update.sh && chmod +x update.sh && ./update.sh ;;
